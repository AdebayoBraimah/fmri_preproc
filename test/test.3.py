...
preproc.run_all(use_mcflirt=True, s2v=False, rdata=rdata, fix_threshold=20, preproc_only=True, spatial_fwhm=4, intnorm=True, quick=True, template_ages='neo')
...
# preproc.run_all(use_mcflirt=False, dc=True, mbs=True, s2v=True, rdata=rdata, fix_threshold=20, template_ages=['neo'])
