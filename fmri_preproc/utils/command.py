...
class Command:
    ...
    def check_dependency(
        self, err_msg: Optional[str] = None, path_envs: Optional[List[str]] = []
    ) -> bool:
        ...
        if not shutil.which(self.command):
            ...
            raise DependencyError(
                f"Command executable not found in system path: {self.command}."
            )
        else:
            return True
