...
def write_func_params(
    ...
    for i in range(len(pedir)):
        ...
        (ax[i], axidx, axdir) = _get_axis(epi=epi, pedir=pedir[i])
...
def _dict2json(dict: Dict, jsonfile: str, indent: int = 4) -> str:
...
def _get_axis(epi: Union[str, nib.Nifti1Image], pedir: str,) -> Tuple[str, str, str]:
    """doc
    """
