...
def arg_parser() -> Tuple[argparse.ArgumentParser.parse_args, argparse.ArgumentParser]:
    ...
    reqoptions.add_argument(
        "--skip-volumetric-atlas", action="store_false", dest="fetch_vol_atlas"
    )

    reqoptions.add_argument(
        "--skip-group-maps", action="store_false", dest="fetch_group_maps"
    )

    reqoptions.add_argument(
        "--skip-group-qc", action="store_false", dest="fetch_group_qc"
    )
