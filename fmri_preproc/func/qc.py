...
class Subject(object):
    ...
    def add_subjectinfo(
        self, subject_id=None, session_id=None, scan_age=None, birth_age=None
    ):
    ...
    def add_reg(
        self, label, source, ref, ref_brainmask, ref_boundarymask=None, ref_dseg=None
    ):
        ...
        normmi = metrics.measurecost(
            source, ref, cost="normmi", ref_brainmask=ref_brainmask
        )
        normcorr = metrics.measurecost(
            source, ref, cost="normcorr", ref_brainmask=ref_brainmask
        )
        ...
        if ref_boundarymask is not None:
            ...
            bbr = metrics.measurecost(
                ...
                ref,
                cost="bbr",
                ref_brainmask=ref_brainmask,
                boundarymask=ref_boundarymask,
            )
        ...
        if template_dseg is not None and template2func_warp is not None:
            ...
            util.run(
                [
                    "applywarp",
                    "-i",
                    template_dseg.get_filename(),
                    "-r",
                    brainmask.get_filename(),
                    "-w",
                    template2func_warp,
                    "-o",
                    dseg,
...
class Group(object):
    ...
    def parse(self, template: str, outname: str):
        ...
        html = template.render(
            group_obj=self, numpy=np, util=util, plot=plot, metrics=metrics
        )
